...
public class CartController : ControllerBase
{
    ...
    public CartController(ICartRepository repository, IRabbitMQMessageSender rabbitMQMessageSender, ICouponRepository coupoRepository)
    {
        ...
        _couponRepository = coupoRepository ?? throw new
            ArgumentNullException(nameof(coupoRepository));
    }
    ...
    public async Task<ActionResult<CheckoutHeaderVO>> Checkout(CheckoutHeaderVO vo)
    {
        ...
        vo.CartDetails = cart.CartDetails ?? new List<CartDetailVO>();
